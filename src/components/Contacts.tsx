...
const Contacts = () => {
    ...
    return (
        <>
            <section id="contatti" className="py-20 bg-gray-900/50">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="bg-dark-bg p-8 rounded-xl shadow-2xl border border-neon-yellow/30">
                            <h3 className="text-2xl font-semibold mb-6 text-gray-100">Richiedi un Appuntamento</h3>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    <label htmlFor="name" className="block text-sm font-medium text-neon-yellow/80">Nome Completo</label>
                                    <input type="text" id="name" name="name" required className="mt-1 block w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-md text-gray-50 focus:border-neon-yellow focus:ring-1 focus:ring-neon-yellow/50 transition duration-200" />
                                </div>
                                <div>
                                    <label htmlFor="email" className="block text-sm font-medium text-neon-yellow/80">Email</label>
                                    <input type="email" id="email" name="email" required className="mt-1 block w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-md text-gray-50 focus:border-neon-yellow focus:ring-1 focus:ring-neon-yellow/50 transition duration-200" />
                                </div>
                                <div>
                                    <label htmlFor="message" className="block text-sm font-medium text-neon-yellow/80">Dettagli della Richiesta</label>
                                    <textarea id="message" name="message" rows={4} required className="mt-1 block w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-md text-gray-50 focus:border-neon-yellow focus:ring-1 focus:ring-neon-yellow/50 transition duration-200"></textarea>
                                </div>
                        ...
                        <div className="space-y-6 md:mt-8">
                            <div className="p-6 bg-dark-bg rounded-xl border border-neon-yellow/30">
                                ...
                                <p className="text-gray-300 flex items-center mb-2">
                                    ...
                                    Via Fittizia, 123 - 00100 Città (Provincia) <span className="text-red-400 font-bold ml-2">(PERSONALIZZA)</span>
                                </p>
                                <p className="text-gray-300 flex items-center mb-2">
                                    <svg className="w-5 h-5 mr-3 text-neon-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                                    <a href="tel:+39061234567" className="hover:text-neon-yellow transition duration-200">+39 **NUMERO REALE**</a>
                                </p>
                                <p className="text-gray-300 flex items-center">
                                    ...
                                    <a href="mailto:info@alessandroparadiso.it" className="hover:text-neon-yellow transition duration-200">info@**TUA EMAIL**</a>
                                </p>
                            </div>
                            <div className="p-6 bg-dark-bg rounded-xl border border-neon-yellow/30">
                                <h3 className="text-xl font-semibold text-neon-yellow mb-3">Orari e Accesso</h3>
                                <p className="text-gray-300 mb-2">Lun - Ven: **ORARIO REALE**</p>
                                <p className="text-gray-300 mb-2">Sab: **ORARIO REALE** (Su Appuntamento)</p>
