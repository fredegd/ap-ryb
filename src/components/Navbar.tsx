...
const Navbar = () => {
  ...
  const contactButtonClass = ({ isActive }: { isActive: boolean }) =>
    `py-1 px-4 rounded-full transition duration-300 ${isActive ? 'bg-neon-yellow text-dark-bg font-bold' : 'text-neon-yellow hover:bg-neon-yellow hover:text-dark-bg'}`;
        ...
        <nav className="hidden md:flex space-x-8 text-sm font-medium items-center">
          ...
          <Link
            ...
            className={isServicesActive
              ...
              : 'text-sm font-medium transition duration-300 text-gray-50 hover:text-neon-yellow'
            }
          >
            Servizi
          </Link>
        ...
        <nav className="flex flex-col items-center  w-full h-screen justify-center gap-8">
          ...
          <Link
            ...
            className={isServicesActive
              ...
              : 'text-4xl font-bold transition duration-300 text-gray-50 hover:text-neon-yellow'
            }
          >
            Servizi
          </Link>
